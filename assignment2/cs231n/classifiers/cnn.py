...
class ThreeLayerConvNet(object):
  ...
  def __init__(self, input_dim=(3, 32, 32), num_filters=32, filter_size=7,
    ...
    H1_out = 1 + (H + 2 * pad - filter_size) / stride
    W1_out = 1 + (W + 2 * pad - filter_size) / stride
  ...
  def loss(self, X, y=None):
    ...
    scores, scores_cache = affine_forward(b, W3, b3)
    ...
    dout, grads['W2'], grads['b2'] = affine_relu_backward(dout, b_cache)
